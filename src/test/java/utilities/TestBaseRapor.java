...
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        String filePath = System.getProperty("user.dir")+"/src/test-outputs/Reports/"+date+".html";
        ...
        extentReports.setSystemInfo("Automation Engineer", "Mehlika");
        extentHtmlReporter.config().setDocumentTitle("Hotel My Camp Testi");
        extentHtmlReporter.config().setReportName("Hotel My Camp Automation Reports");
    }
